...
class TipoUsuario(models.Model):
    ...
    permisos = models.CharField(
        max_length=255, null=True, db_column='permisos')
...
class Usuario(models.Model):
    ...
    imagen_url = models.CharField(max_length=255, db_column='imagen_url', null=True)
...
class Proveedor(models.Model):
    ...
    id_distrito = models.ForeignKey(Distrito, on_delete=models.CASCADE, db_column='id_distrito')
    nombre = models.CharField(max_length=50, db_column='nombre')
    apellido_paterno = models.CharField(max_length=60, db_column='apellido_paterno')
    apellido_materno = models.CharField(max_length=60, null=True, db_column='apellido_materno')
