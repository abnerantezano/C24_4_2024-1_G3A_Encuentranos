...
urlpatterns = [
    ...
    path('reportes/servicios-con-proveedores/', views.ReporteServiciosAPIView.as_view(), name='reporte_servicios_con_proveedores'),
    path('reportes/clientes-con-mas-contratos/', views.ReporteClientesAPIView.as_view(), name='reporte_clientes_con_mas_contratos'),
]