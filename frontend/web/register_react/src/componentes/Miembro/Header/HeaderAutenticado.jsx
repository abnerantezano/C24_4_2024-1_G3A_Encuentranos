              ...
              <div className="px-6 xl:px-36 flex flex-wrap items-center justify-between mx-auto py-4">
                ...
                <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
                  <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white">
                    ...
                    <li>
                      <Link to="/servicios" className={`block py-2 px-3 ${location.pathname === '/servicios' ? 'text-[#B4663F] font-bold' : 'text-gray-900'} md:p-0`}>Servicios</Link>
                    </li>
                    <li>
                      <Link to="/precios" className={`block py-2 px-3 ${location.pathname === '/precios' ? 'text-[#B4663F] font-bold' : 'text-gray-900'} md:p-0`}>Precios</Link>
                    </li>
                  </ul>
                </div>
              </div>
