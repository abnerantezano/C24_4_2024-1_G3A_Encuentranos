...
class DetalleNotificacionesAdapter : RecyclerView.Adapter<DetalleNotificacionesAdapter.DetalleNotificacionesViewHolder>() {

    private var detallesContrato: List<DetalleContratoModel> = emptyList()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DetalleNotificacionesViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_notificaciones, parent, false)
        return DetalleNotificacionesViewHolder(view)
    }

    override fun onBindViewHolder(holder: DetalleNotificacionesViewHolder, position: Int) {
    ...
    inner class DetalleNotificacionesViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
