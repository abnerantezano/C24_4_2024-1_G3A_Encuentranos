...
public class MensajeServicio {
    ...
    public List<MensajeModelo> getMensajesByEmisorId(Integer emisorId) {
        return mensajeRepositorio.findByIdEmisorIdUsuario(emisorId);
    }
    ...
    public List<MensajeModelo> obtenerMensajePorIdChat(Integer receptorId) {
        return mensajeRepositorio.findByIdReceptorIdUsuario(receptorId);
    }

    public MensajeModelo crearMensaje(MensajeModelo mensaje) {
