        ...
        <div className='bg-[#F5F5F5]'>
          <div className='px-6 xl:px-36 flex flex-wrap items-center justify-between mx-auto py-16'>
            <div className='w-1/2 p-20'>
              ...
              <a href="/configuracion/mis-servicios" className='text-white bg-[#E8A477] p-3 rounded-lg xl:text-base hover:bg-[#BC7547] focus:ring-4 focus:ring-[#BC7547]'>Agregar servicios</a>
            </div>
            <div className='w-1/2'>
