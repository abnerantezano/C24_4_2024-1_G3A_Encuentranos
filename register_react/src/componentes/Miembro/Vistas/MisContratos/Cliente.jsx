...
function MisContratosCliente() {
    ...
    const filtrarContratos = (contratos) => {
        ...
        return contratos.filter((contrato) => {
            const nombreProveedor = `${contrato.idProveedor.nombre} ${contrato.idProveedor.apellidoPaterno}`.toLowerCase();
                ...
                <div className='flex flex-col px-4'>
                    <div className='flex flex-wrap justify-start'>
                        ...
                        <div className='flex flex-col pl-6'>
                            ...
                            <p className='text-base font-semibold'>{`${contrato.idProveedor.nombre.split(' ')[0]} ${contrato.idProveedor.apellidoPaterno}`}</p>
                        </div>
                    </div>
