                            ...
                            <div class="px-6 xl:px-36 flex flex-wrap items-center justify-between mx-auto py-4">
                                ...
                                <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                                    ...
                                    <button type="button" onClick={() => setAbrirPerfil((prev) => !prev)} ref={perfilRef} class="flex text-sm rounded-full md:me-0">
                                        ...
                                        <img class="w-8 h-8 rounded-full object-cover" src={info.imagenUrl} alt="Foto de perfil" />
                                    </button>
                                ...
                                <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
                                    <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                                        <li>
                                            <a href="/inicio" className={`block py-2 px-3 ${activeLink === '/inicio' ? 'text-[#B4663F]' : 'text-gray-900'} md:text-[#B4663F] md:p-0 md:dark:text-white`} onClick={() => handleSetActiveLink("/inicio")}>Inicio</a>
                                        </li>
                                        <li>
                                            <a href="/servicios" className={`block py-2 px-3 ${activeLink === '/servicios' ? 'text-white' : 'text-gray-900'} md:hover:text-[#B4663F] md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700`} onClick={() => handleSetActiveLink("/servicios")}>Servicios</a>
                                        </li>
                                        <li>
                                            <a href="/precios" className={`block py-2 px-3 ${activeLink === '/precios' ? 'text-white' : 'text-gray-900'} md:hover:text-[#B4663F] md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700`} onClick={() => handleSetActiveLink("/precios")}>Precios</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
