...
const AgregarServicio = () => {
    ...
    const agregarServicio = (e) => {
        ...
        ServicioProveedor.postAddServicioProveedor(serviciosData)
            .then((response) => {
                        ...
                        {serviceData.map((service, show) => (
                            <div key={show} className="grid md:grid-cols-2 md:gap-6">
                                <div className="relative z-0 w-full group">
                                    ...
                                    <select  name="idServicio"  value={idServicio} onChange={(e) => handleChange(show, e)} className="mb-5 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-yellow-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                                ...
                                <div className="relative z-0 w-full mb-5 group">
                                    ...
                                    <input type="text" name="Precio" value={Precio} onChange={(e) => handleChange(show, e)} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-yellow-600 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required
                                    />
                                </div>
                            </div>
                        ))}
